...
const Leadership = () => {
  ...
  return (
    <div className="group w-full md:w-3/3 p-6 bg-white/10 backdrop-blur-md border border-white/15 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in animate-delay-200">
        ...
        <div className="bg-white/10 border border-white/10 rounded-md p-4">
          ...
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <div className="text-neutral-50 font-semibold">Incoming SWE Intern</div>
            </div>
            <div className="bg-white/15 text-neutral-200 px-3 py-1 rounded-full text-sm font-medium border border-white/10">
              May 2026 – Aug 2026
            </div>
          </div>
        ...
        <div className="bg-white/10 border border-white/10 rounded-md p-4">
          ...
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <div className="text-neutral-50 font-semibold">Associate Software Engineering Intern</div>
            </div>
            <div className="bg-white/15 text-neutral-200 px-3 py-1 rounded-full text-sm font-medium border border-white/10">
              Jan-24 Jun-24
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
            <div className="bg-white/10 border-l-4 border-white/20 p-3 rounded-r-md">
              <div className="flex items-center gap-2">
                <Brain className="w-4 h-4 text-neutral-300" />
                <span className="text-sm font-semibold text-neutral-100">Built RAG Applications</span>
              </div>
              <p className="text-xs text-neutral-400 mt-1">Natural language querying across multiple data sources</p>
            </div>
            <div className="bg-white/10 border-l-4 border-white/20 p-3 rounded-r-md">
              <div className="flex items-center gap-2">
                <BarChart3 className="w-4 h-4 text-neutral-300" />
                <span className="text-sm font-semibold text-neutral-100">Interactive Dashboards</span>
              </div>
              <p className="text-xs text-neutral-400 mt-1">Streamlit-based visualization with dynamic graphs</p>
            </div>
          </div>
          ...
          <div className={`overflow-hidden transition-all duration-300 ${isOpen ? 'max-h-[600px] mt-4' : 'max-h-0'}`}>
            <div className="space-y-3">
              {achievements.map((achievement, index) => (
                <div key={index} className="flex items-start gap-3 p-3 bg-white/10 border border-white/10 rounded-md">
                  <div className="bg-white/15 text-neutral-200 p-2 rounded-full flex-shrink-0 border border-white/10">
                    {achievement.icon}
                  </div>
                  <div>
